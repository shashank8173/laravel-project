...
<div class="pj-wrap">
    <div class="pj-panel">
        <div class="pj-panel-head"><h5>{{ $project->name }}</h5></div>
        <div class="pj-panel-body">
            <form method="POST" action="{{ route('projects.update', $project) }}">
                @csrf
                @method('PUT')
                @include('projects._form', ['project' => $project, 'employees' => $employees, 'priorities' => $priorities, 'statuses' => $statuses, 'includeTeam' => false])
